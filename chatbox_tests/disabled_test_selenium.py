...
class TestState:
    def __init__(self):
        ...
        self.server_obj: chatbox_websocket_server.Server = None
...
@pytest.mark.asyncio
async def test_first_connection(state: TestState):
...
# @pytest.mark.asyncio
# async def test_sending_and_displaying_messages(state: TestState):
